...
class MTLModel:
    ...
    def MTL_ours(self, x, y, r=3, T1=1, T2=0.05, R=5, r_bar=5, eta=0.05, max_iter=2, C1=1, C2=0.5, delta=0.05,
                 adaptive=False):
        T = x.shape[0]
        n = x.shape[1]
        p = x.shape[2]
        ...
        # print("At the end of MTL_ours before write, Abar:", A_bar)
        # print("At the end of MTL_ours before write, Abar_old:", self.Abar_old)
        #
        ...
        # print("Abar_old_array:",abar_old_array)
        # print("Abar_ours:", A_bar)
        # print("Abar_old_ours:", self.Abar_old)
        ################################################################################################################
    ...
    def our_task_outlier(self, h):
        ...
        # MTL ours
        beta_hat_ours = self.MTL_ours(x=x, y=y, r=3, max_iter=2, eta=0.05)

        # MTL ours: adaptive
        beta_hat_ours_ad = self.MTL_ours(x=x, y=y, r=3, r_bar=sqrt(T), max_iter=2, eta=0.05, adaptive=True)
...
with open("C:/Users/samoh/PycharmProjects/MTLa/venv/TL.py" + str(0) + "_outlier_TL1.csv", "w",
            newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=',')
    writer.writerows(mse_outlier)

with open("C:/Users/samoh/PycharmProjects/MTLa/venv/TL.py" + str(0) + "_noisier_TL1.csv", "w",
            newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=',')
